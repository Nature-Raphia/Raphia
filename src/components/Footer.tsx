        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a
                href="https://www.instagram.com/nature.raphia"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#C97A53] flex items-center justify-center transition-colors"
              ...
              <a
                href="https://web.facebook.com/profile.php?id=100078083941538"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#C97A53] flex items-center justify-center transition-colors"
                aria-label="Facebook"
