        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#C97A53] flex items-center justify-center transition-colors" aria-label="Instagram">
              ...
              <a href="#" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#C97A53] flex items-center justify-center transition-colors" aria-label="Facebook">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-2 text-sm text-white/60">
                ...
                <span>Rue de l'Indépendance, Antsirabe 110, Madagascar</span>
              </div>
