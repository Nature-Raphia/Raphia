  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        ...
        <h1 className={`font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-white leading-[1.1] tracking-wide mb-8 transition-all duration-700 delay-100 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`} style={{ textShadow: '0 0 20px rgba(255,255,255,0.4), 0 0 60px rgba(255,255,255,0.15), 0 0 100px rgba(255,255,255,0.08)' }}>
          De la fibre sauvage{' '}
          <span className="italic" style={{ color: '#E6DFD3', textShadow: '0 0 20px rgba(230,223,211,0.4), 0 0 60px rgba(230,223,211,0.15)' }}>à l'accessoire d'exception</span>
          .
        </h1>

        <p className={`text-white/70 text-base sm:text-lg leading-relaxed max-w-xl mx-auto mb-10 transition-all duration-700 delay-200 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          Depuis les hautes terres d'Antsirabe, nos artisanes tissent chaque pièce à la main, tressant héritage, patience et beauté brute dans une signature 100% Madagascar.
        </p>
      ...
      >
        <span className="text-[10px] uppercase tracking-[0.2em] font-light">Faire défiler</span>
